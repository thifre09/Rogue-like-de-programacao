    ...
    public void StartCard()
    {
        ...
        switch (cardType)
        {
            case CardType.Boolean:
                StartBoolean();
                color = new Color32(255, 140, 40, 255);
                break;
            case CardType.Float:
                StartFloat();
                color = new Color32(255, 69, 69, 255);
                break;
            case CardType.Integer:
                StartInteger();
                color = new Color32(76, 194, 255, 255);
                break;
            case CardType.List:
                StartList();
                color = new Color32(255, 241, 40, 255);
                break;
            case CardType.Null:
                StartNull();
                color = new Color32(185, 93, 231, 255);
                break;
            case CardType.String:
                StartString();
                color = new Color32(28, 219, 48, 255);
                break;
        }
    }
}